...
async def _(event):
    ...
    await sedthon.send_file(event. chat_id, 'https://t.me/yyyyyy3w/3', caption='''FURY 𝗰𝗵𝗲𝗰𝗸𝗲𝗿 𝗶𝘀 𝘄𝗼𝗿𝗸𝗶𝗻𝗴 
...
async def _(event):
      await event.reply("""السـورس يعمـل |FURY CHECKER
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
